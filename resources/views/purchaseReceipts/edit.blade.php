...
@section('page_content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            <form id="createNewPurchaseForm" role="form" action="{{ route('purchase.store') }}" method="POST">
                {{ csrf_field() }}
                <div class="form-body" id="create-purchase-form">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group form-md-line-input">
                                <div class="input-group date form_datetime">
                                    <input type="text" readonly size="16" class="form-control" name="datetime" value="{{ $currentPurchase->datetime->format('d-m-Y H:i') }}">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group form-md-line-input">
                                        <select class="form-control select2me" id="supplier_id" name="supplier_id">
                                            @foreach ($suppliers as $supplier)
                                                    <option value="{{ $supplier->id }}" @if($supplier->id == $currentPurchase->supplier_id) selected @endif>
                                                        <b>{{ $supplier->name }}</b> --- {{ $supplier->company }}
                                                    </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-md-line-input">
                                        <div class="md-checkbox md-checkbox-inline">
                                            <input onchange="calculateTotal();" type="checkbox" id="vat" name="vat" class="md-check" @if($currentPurchase->vat) checked @endif>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="alert alert-info text-center" id="total">
                                        <strong>{{ $currentPurchase->total }}</strong>
                                        <input type="hidden" name="total" value="{{ $currentPurchase->total }}">
                                        <input type="hidden" name="purchase_id" value="{{ $currentPurchase->id }}">
                                    </div>
                                </div>
                                <div class="col-md-5 group-tools">
                                    <a onclick="showHidePurchaseNote();" class="btn btn-circle btn-icon-only btn-default"
                                       href="javascript:;">
                    ...
                    <div class="row" id="purchase-note-field" @if (!$currentPurchase->other_cost && !$currentPurchase->reduction && !$currentPurchase->note) hidden @endif>
                        <div class="col-md-3">
                            <div class="form-group form-md-line-input">
                                <div class="input-group">
                                    <input onblur="calculateTotal();" type="text"
                                           ...
                                           value="{{ $currentPurchase->other_cost }}"
                                    >
                                ...
                                <div class="input-group">
                                    <input onblur="calculateTotal();" type="text"
                                           ...
                                           placeholder="Giảm giá trên đơn hàng"
                                            value="{{ $currentPurchase->reduction }}"
                                    >
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                        <textarea class="form-control" name="note" id="note"
                                                  placeholder="Ghi chú của đơn hàng">@if ($currentPurchase->note) {{ $currentPurchase->note }} @endif</textarea>
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group form-md-line-input">
                                        <div class="input-group">
                                            <input type="hidden" name="purchase_detail_id[]" value="0">
                ...
                @foreach ($currentPurchase->purchaseReceiptDetails as $purchaseDetail)
                                ...
                                <div class="col-md-5">
                                    <div class="form-group form-md-line-input has-info">
                                        <select onchange="getItems(this);" class="form-control" id="category_id"
                                            ...
                                            <option value="0">--Select category--</option>
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @if($purchaseDetail->item->category->id == $category->id) selected @endif>{{ $category->name }}</option>
                                            @endforeach
                                        </select>
                                        {{--<label for="category_id">Loại hàng</label>--}}
                                    </div>
                                ...
                                <div class="col-md-7">
                                    <div class="form-group form-md-line-input">
                                        <select onchange="selectItem(this);" class="form-control list-items"
                                                id="item_id"
                                                name="item_id[]">
                                            <option value="{{ $purchaseDetail->item_id }}"></option>
                                        </select>
                                        {{--<label for="item_id">Mặt hàng</label>--}}
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <div class="input-group">
                                            <input onblur="calculateSum(this);" type="text"
                                                   class="form-control my-currency" id="price" value="{{ $purchaseDetail->price }}"
                                                   name="price[]" placeholder="Đơn giá">
                                            <span class="help-block">Đơn giá</span>
                                            <label for="price"></label>
                                            <span class="input-group-addon">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <div class="input-group right-addon">
                                            <input onchange="calculateSum(this);" type="number" min="1"
                                                   class="form-control"
                                                   id="quantity" value="{{ $purchaseDetail->quantity }}"
                                                   name="quantity[]" placehoder="SL">
                                            <label for=""></label>
                                            <span class="help-block">SL</span>
                                            <span class="input-group-addon unit"></span>
                                ...
                                <div class="col-md-7">
                                    <div class="form-group form-md-line-input">
                                        <div class="input-group">
                                            ...
                                            <input type="text" min="0" readonly disabled
                                                   class="form-control my-currency" id="sum"
                                                   name="sum[]" value="{{ $purchaseDetail->sum }}"
                                                   placeholder="Tổng">
                                            <label for="sum">Tổng</label>
                                            <span class="input-group-addon">
                                                <i class="fa fa-usd"></i>
                        ...
                        <div class="col-md-12 note-field" @if(!$purchaseDetail->reduction_on_item && !$purchaseDetail->note_on_item && !$purchaseDetail->other_cost_on_item) hidden @endif>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group form-md-line-input">
                                        <div class="input-group">
                                            <input onblur="calculateSum(this);" type="text"
                                                   class="form-control my-currency"
                                                   id="other_cost_on_item"
                                                   name="other_cost_on_item[]" value="{{ $purchaseDetail->other_cost_on_item }}"
                                                   placeholder="Chi phí khác">
                                            <span class="help-block">Chi phí khác</span>
                                            <span class="input-group-addon">
                                                <i class="fa fa-usd"></i>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <div class="input-group">
                                            <input onblur="calculateSum(this);" type="text"
                                                   class="form-control my-currency"
                                                   id="reduction_on_item"
                                                   name="reduction_on_item[]" value="{{ $purchaseDetail->reduction_on_item }}"
                                                   placeholder="Giảm giá">
                                            <span class="help-block">Giảm giá</span>
                                            <span class="input-group-addon">
                                                <i class="fa fa-usd"></i>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <textarea class="form-control" name="note_on_item[]" id="note_on_item"
                                                  placeholder="Ghi chú">{{ $purchaseDetail->note_on_item }}</textarea>
                                        <span class="help-block">Ghi chú</span>
                                        <label for="note_on_item"></label>
                                    </div>
                                </div>
...
@section('my_scripts')
    <script>
        ...
        function showHidePurchaseNote() {
            $('#purchase-note-field').toggle("slide");
        }
        ...
        function calculateTotal() {
            var total = 0;
            $('#create-purchase-form').find(".row.section input[name^='sum']").each(function () {
        ...
        function destroyPurchase() {
            swal({
                ...
                $.ajax({
                    url:"/ajax/purchase/" + $("#createNewPurchaseForm").find("input[name='purchase_id']").val(),
                    type: "DELETE",
                    success:function(data) {
                        swal(
                                'Đã xóa!',
    ...
    <script>
        ...
        var currencyEls = $(".row.section, #purchase-note-field").find('.my-currency');
        ...
        $('#createNewPurchase').click(function (e) {
            ...
            swal({
                ...
                var form = $("#createNewPurchaseForm");
                var rowData = [];
                var purchaseId = form.find("input[name='purchase_id']").val();
                form.find('.row.section').each(function() {
                    ...
                    rowData.push({
                        "id": $(this).find("input[name^='purchase_detail_id']").val(),
